    ...
    <div class="card shadow mb-2">
        ...
        ?>
            <div class="card-body">
                ...
                $cekdata= $this->model_krwenduser->allbyidwil_row($idwil);
                if(isset($cekdata)){
                    $krws = $this->model_krwenduser->allbyidwil($idwil);
                    foreach ($krws as $krw) {
                        $ikrw[0] = '-';
                    ...
                    <div class='col-sm-8'>
                        <div class='form-group'>".
                            form_label('Nama Petugas', 'krw') . form_dropdown('krw', $ikrw, set_value('krw'), 'class="form-control"') . form_error('krw')
                        ."</div>
                    </div>
                    ";
                }
